...
public class QuerydslBasicTest {
    ...
    public void join_on_filtering(){
        ...
        /**
         * inner join일 때는 on절보다는 where절을 사용
        queryFactory
                .select(member, team)
                .from(member)
                .join(member.team, team)
    ...
    /**
     * DB 컨텍스트를 무시하고 db를 바꾼다.
     * 해결방안 벌크 연산 후 영속성 컨텍스트를 초기화 시켜준다.
     */
    @Test
